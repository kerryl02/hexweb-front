      ...
      <div>
        <div className="container z-30 grid grid-cols-4 pb-12 sm:grid-cols-8 lg:grid-cols-12 gap-x-4 gap-y-10 place-self-end lg:py-12">
          <div className="flex flex-col col-span-4 col-start-1 xl:col-span-6 gap-y-10 sm:col-span-6 md:col-span-5">
            ...
            <p className="text-lg font-semibold font-nunito-sans lg:text-xl">
        ...
        <div className="container flex flex-col justify-end sm:flex-row gap-y-8 gap-x-4">
          <div className="flex flex-col items-center justify-end basis-1/2 md:flex-row gap-x-4 gap-y-4">
            ...
            <p className="text-sm leading-5 tracking-tight text-center text-black md:w-52 sm:text-left font-nunito-sans">20% de réduction sur votre premier site web sur mesure !</p>
          </div>
        </div>
      </div>
    </Section>
