  ...
  <div className="w-full">
    <div className="flex flex-col justify-between h-full">
      <p className="text-xl font-nunito-sans">
        <strong>Améliorez votre visibilité en ligne</strong> avec nos services de
      ...
      <p className="mt-4 text-xl font-nunito-sans">
        Contactez-nous pour transformer votre site en un <strong>levier de croissance !</strong>
      </p>

      <p className="mt-4 text-xl font-nunito-sans">
        <strong>Agence web en France</strong>, nous accompagnons PME, startups et e-commerces 
        dans leurs projets digitaux. Que vous cherchiez une<strong> création sur-mesure </strong>
        ou une <strong>refonte optimisée</strong>, nous développons des solutions adaptées à vos besoins spécifiques.
      </p>

      <p className="mt-4 text-xl font-nunito-sans">
        <strong>Experts en SEO, UX/UI et design responsive</strong>, nous créons des sites web modernes, 
        performants et évolutifs. Grâce aux meilleures pratiques en webmarketing, nous vous aidons à
        <strong> attirer, engager et convertir</strong> vos visiteurs en clients.
      </p>

      <p className="mt-4 text-xl font-nunito-sans">
        Découvrez comment <strong>Hexweb</strong> peut accélérer votre croissance digitale 
