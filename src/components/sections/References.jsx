      ...
      <Section>
        <div>
          <div className='flex justify-center'>
            <h2 className='text-2xl lg:text-[2rem] font-bold'>Découvrez Comment Notre Site Web Peut Transformer Votre Business !</h2>
          </div>
          <div className='grid grid-cols-4 gap-4 pt-12 sm:grid-cols-6'>
              {/* Card des bénéfit*/}
            <div className='flex flex-col col-span-3 col-start-1 sm:col-span-2'>
              <div className='flex justify-center'>
            ...
            <div className='flex flex-col col-span-3 col-start-2 sm:col-span-2'>
              <div className='flex justify-center'>
                <div className='w-28 lg:w-36 '>
