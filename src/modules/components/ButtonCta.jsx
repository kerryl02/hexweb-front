...
const ButtonCta = ({children, link, className, classNameB}) => {
  return (
    <Link
      to={link}
    ...
    >
      <span 
      className={classNameB ? ` ${classNameB}` : `font-bold text-lg relative px-5 py-2.5 transition-all ease-in duration-75 group-hover:bg-white dark:bg-gray-900 rounded-full bg-opacity-0 font-nunito-sans` }
      >
        {children}
      </span>
    </Link>
